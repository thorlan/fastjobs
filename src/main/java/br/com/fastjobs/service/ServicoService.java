...
public class ServicoService {
	...
	public Servico atualizar(Long id, @Valid Servico servico) {
		...
		Servico servicoSalvo = this.servicoRepository.findById(id)
				.orElseThrow(() -> new RecursoInexistenteException("Serviço não inexistente"));
	...
	public Servico salvar(Servico servico) {
		...
		if (servico.getUsuario().getId() == null
				|| !usuarioRepository.findById(servico.getUsuario().getId()).isPresent()) {
